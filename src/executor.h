...
namespace wwivbasic {
  ...
  public:
    ...
    //std::any visitEmptyStatement(BasicParser::EmptyStatementContext* context) override;
    ...
    //std::any visitAdditiveoperator(BasicParser::AdditiveoperatorContext* context) override;

    //std::any visitMultiplicativeoperator(BasicParser::MultiplicativeoperatorContext* context) override;

    //std::any visitRelationaloperator(BasicParser::RelationaloperatorContext* context) override;

    std::any visitAssignmentStatement(BasicParser::AssignmentStatementContext* context) override;

    //std::any visitIfStatement(BasicParser::IfStatementContext* context) override;
    ...
    //std::any visitPackageName(BasicParser::PackageNameContext* context) override;
